...
function answerResponse() {
    ...
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q35 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q36 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q37 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q38 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q39 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q40 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q41 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q42 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q43 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q44 = window.btoa(document.getElementById("s34" + j).value);
    }
    for (var j = 1; j < 6; j++) {
        if (document.getElementById("s5" + j).checked)
            response.q45 = window.btoa(document.getElementById("s34" + j).value);
    }
